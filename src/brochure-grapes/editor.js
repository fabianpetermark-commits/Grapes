// Legacy GrapesJS brossúra-motor (?engine=grapes).
//
// Ez a fájl a korábbi src/main.js GrapesJS-részének szó szerinti
// áthelyezése. Szándékosan nem kap UI-átdolgozást: a Fabric-motor vette át
// az alapértelmezett szerepet, ez csak a régi projektek megnyitásáig marad.
//
// A modul törzse top-level kód, ezért a dinamikus import maga a lusta
// betöltés: a GrapesJS és a nyolc pluginja csak akkor kerül le a hálóról és
// csak akkor inicializálódik, ha valaki tényleg ezt a motort kéri. Korábban
// a main.js tetején statikus import volt, és a grapesjs.init() top-level
// futott — a nyitóképernyő és a 3D stúdió is megfizette a teljes
// szerkesztő-indítás árát.
...
// A képernyőváltó hívja, amikor ez a motor kerül előtérbe.
